...
which_die = "d4c"; //  ["d2","d4","d6","d8","d10","d100","d12","d20","d20c"]

// ^ true to draw the numbers, false to make blank faces
draw_text = true;

dice_style = "chub"; // ["chessex", "chub", "crystal"]
...
module drawWhich(which="d4") {
 difference() {
    ...
    // if (which=="d4c")   draw_d4(d4c_face_edge,              d4c_font_scale * font_sizing_pct,   d4c_vertical_offset, dice_style);
    ...
    if (which=="d10")   draw_d10(d10_face_edge,             d10_font_scale * font_sizing_pct,   d10_vertical_offset, false, dice_style);
    if (which=="d100")  draw_d10(d10_face_edge,             d100_font_scale * font_sizing_pct,  d100_vertical_offset, true, dice_style);
