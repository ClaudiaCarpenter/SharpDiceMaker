...
extrude_depth = 1.60; // [0.00:0.01:2.00]
...
d2_height = 25; // [5:0.1:100]
d2_font_scale = 100;
d2_vertical_offset = 0; // [-5.0:0.1:5.0]
...
finishing = .15;
d4_face_edge = triangle_edge(d4_height) + finishing;
d4c_face_edge = d4c_height + finishing;
d6_face_edge  = (d6_height + finishing) * 1;
d8_face_edge  = (d8_height + finishing) * .707;
d10_face_edge = (d10_height + finishing) * 0.68;
d10c_face_edge = (d10c_height + finishing) * 0.5;
d12_face_edge  = (d12_height + finishing) * 0.5597;
d20_face_edge  = (d20_height + finishing) * 0.5062;
d20c_face_edge  = (d20c_height + finishing) * 0.5062;

module drawWhich(which="d4") {
 difference() {
    if (which=="d2")    draw_d2(d2_height + finishing,     d2_font_scale,    d2_vertical_offset);
