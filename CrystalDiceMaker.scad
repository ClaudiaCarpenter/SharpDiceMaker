...
d2_font_scale = 100;
d2_vertical_offset = 0.0;
d4_vertical_offset = 0.0;
d4_extrude_depth = 0.8;
d4c_vertical_offset = 0.0;
d6_vertical_offset = 0.0;
d8_vertical_offset = 0.0;
d10_vertical_offset = 0.0;
d100_vertical_offset = 0.0;
d12_vertical_offset = 0.0;
d20_vertical_offset = 0.0;
d20c_vertical_offset = 0.0;
...
svg_path = "/Users/cloudi/Dev/SharpDiceMaker/svg/rounded_shapes/SVG";
svg_path_offset = 0.6;
svg_overlay = "";
...
module drawWhich(which="d4") {
 difference() {
    ...
    if (which=="d4")    draw_d4(d4_face_edge,               d4_font_scale * font_sizing_pct,    d4_vertical_offset, dice_style);
    if (which=="d4c")   draw_d4(d4c_face_edge,              d4c_font_scale * font_sizing_pct,   d4c_vertical_offset, "crystal");
    ...
    if (which=="d10")   draw_d10(d10_face_edge,             d10_font_scale * font_sizing_pct,   d10_vertical_offset, false, "chessex");
    if (which=="d100")  draw_d10(d10_face_edge,             d100_font_scale * font_sizing_pct,  d100_vertical_offset, true, "chessex");
    if (which=="d10c")   draw_d10(d10_face_edge,             d10_font_scale * font_sizing_pct,   d10_vertical_offset, false, "crystal");
    if (which=="d100c")  draw_d10(d10_face_edge,             d100_font_scale * font_sizing_pct,  d100_vertical_offset, true, "crystal");
