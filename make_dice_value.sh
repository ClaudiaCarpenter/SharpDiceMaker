...
gen_die_value() {
  printf "Rendering $DIR/$1_$3_$4.stl...-D "$3=\"$4\""\n"
  $OPENSCAD -o $DIR/$1_$3_$4.stl -D "which_die=\"$1\"" -D "$3=$4" -p $PRESETS -P "$NAME" CrystalDiceMaker.scad
}
...
gen_die_value d6 $1 "supports_height" 3
gen_die_value d6 $1 "supports_height" 5
gen_die_value d6 $1 "supports_height" 8
gen_die_value d6 $1 "supports_height" 12
gen_die_value d6 $1 "supports_height" 15
